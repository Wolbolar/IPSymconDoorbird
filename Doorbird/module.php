    ...
    protected function SetupVariables()
    {
        ...
        if($this->ReadPropertyBoolean('slideshow_history'))
        {
            if ($model == self::D101 || $model == self::D202 || $model == self::D2101V || $model == self::D21DKV || $model == self::D21DKH || $model == self::D2102V || $model == self::D2103V) {
                ...
                $icon = IPS_GetObject($this->GetIDForIdent('slideshow_history_1'))['ObjectIcon'];
                if($icon == '')
                {
            ...
            if ($model == self::D2102V || $model == self::D2103V) {
                ...
                $icon = IPS_GetObject($this->GetIDForIdent('slideshow_history_2'))['ObjectIcon'];
                if($icon == '')
                {
                    IPS_SetIcon($this->InstanceID, 'Camera');
                }
            ...
            if ($model == self::D2103V) {
                ...
                $icon = IPS_GetObject($this->GetIDForIdent('slideshow_history_3'))['ObjectIcon'];
                if($icon == '')
                {
                    IPS_SetIcon($this->InstanceID, 'Camera');
                }
...
<body>
  ...
  <div class="container">';
    ...
    {
        $description = IPS_GetObject($media_object)['ObjectInfo'];
        return $description;
    }
