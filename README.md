...
Modul für IP-Symcon ab Version 9.0. Ermöglicht die Kommunikation mit einer Doorbird Türsprechanlage.

 - 🇩🇪 [Deutsche Dokumentation](docs/de/README.md "Deutsche Dokumentation")
 
Module for IP-Symcon from version 9.0. Allows communication with a Doorbird doorphone.
